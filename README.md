...
*Resolving a URL example*

![example](/assets/example.gif)
*layout and render example*
...
- `Slots`: Slots are defined by folder names starting and ending with **(*slot_name*)**
...
## Create App
- Instatiate the router - creates the execution tree *(next version will be able to take a manually configured routing tree)* 
...
- define a layout *(layout definitions for Dash must be sync)*
...
- *upcoming version will have a method to securely create urls in your layout*
...
- *upcoming version will have type conversions and a <...rest> template that takes all remaing segments as arguments*
